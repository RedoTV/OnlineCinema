...
namespace OnlineCinema.Backend.Services.Seeding;
...
public class DemoSeeder
{
    ...
    public async Task SeedAsync()
    {
        ...
        {
            var s = new Models.Series { Title = title, ReleaseYear = year, Description = $"Сериал {title}.", Genres = new List<Genre> { g1, g2 } };
    ...
    private async Task SeedDemoMediaAsync(IReadOnlyList<Movie> movies, IReadOnlyList<Models.Series> series)
    {
